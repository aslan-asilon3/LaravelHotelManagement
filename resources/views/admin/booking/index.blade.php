					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
                                ...
                                <a href="/admin/booking/add" class="btn btn-primary float-right veiwbutton ">Add Booking</a>
                            </div>
						</div>
					</div>
				</div>
										...
										<tbody>
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-03.jpg') }}" alt="User Image"></a>
												...
												<td class="text-right">
													<div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
														<div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="/admin/booking/edit"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
													</div>
												</td>
											</tr>
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-04.jpg') }}" alt="User Image"></a>
											...
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                    <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-05.jpg') }}" alt="User Image"></a>
											...
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                    <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-06.jpg') }}" alt="User Image"></a>
											...
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                    <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-07.jpg') }}" alt="User Image"></a>
											...
											<tr>
												...
												<td>
													<h2 class="table-avatar">
                                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ url('admin-asset/img/profiles/avatar-08.jpg') }}" alt="User Image"></a>
			...
			<div id="delete_asset" class="modal fade delete-modal" role="dialog">
				<div class="modal-dialog modal-dialog-centered">
					<div class="modal-content">
						<div class="modal-body text-center"> <img src="admin-asset/img/sent.png" alt="" width="50" height="46">
