...
<div class="content container-fluid">
		<div class="page-header">
					<div class="row bg-white">
										<p class="page-title mt-3">Selamat Datang  <span style="font-weight:bold; text-decoration:underline;"></span> ! Anda Login Sebagai Admin</p>
										<button type="button" class="btn btn-primary float-right veiwbutton h-5 w-5 items-center">Veiw All</button>
						</div>
					</div>
				</div>
				<div class="row">
